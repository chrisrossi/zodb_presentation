...
class FunctionalTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        zodb_uri = 'file://%s?blobstorage_dir=%s' % (data_fs, blobs)
        self.site_ini = path = os.path.join(tmp, 'site.ini')
        with open(path, 'w') as out:
            out.write(site_ini % zodb_uri)
    ...
    def make_application(self):
        ...
        settings = {'sites_config': self.site_ini}
